...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fakeredis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6798&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fakeredis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fakeredis` can be installed with:

```
conda install fakeredis
```

It is possible to list all of the versions of `fakeredis` available on your platform with:
